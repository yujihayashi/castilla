							...
							<div class="col-md-2 col-sm-3">
								<ul class="menu-footer">
									<li>
										...
										<ul>
											<li><a href="#" title="">Curso de Espanhol</a></li>
											<li><a href="#" title="">Curso de Inglês</a></li>
											<li><a href="#" title="">Curso de Italiano</a></li>
											<li><a href="#" title="">Curso de Francês</a></li>
											<li><a href="#" title="">Curso de Alemão</a></li>
										</ul>
									</li>
								</ul>
							</div> <!-- .col-md-2 -->
