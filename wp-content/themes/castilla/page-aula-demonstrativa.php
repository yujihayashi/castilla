...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="box-imagem" style="background-image:url(<?php echo get_template_directory_uri(); ?>/img/aula-demonstrativa.jpg);">
				...
				<div class="col-md-7 col-md-offset-5 col-sm-6 col-sm-offset-6">
					<div class="entry-content">
						...
						<form action="">
							...
							<p class="text-right">
								<button class="btn btn-black btn-sm" type="submit">ENVIAR</button>
							</p>
						</form>
						<?php
						wp_link_pages( array(
